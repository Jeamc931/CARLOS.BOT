...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Tio Carlos\n' // Nama kamu
            + 'ORG:Tio Carlos;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5594992856640:+55 92856640\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '!','!','#'
blocked = []
limitawal = '999999999'
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["5594992856640@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5594992856640@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5594992856640@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5594992856640@s.whatsapp.net"]//ubah nomor l
...
client.sendMessage(from, result, sticker, {quoted: mek })
           ...
           return console.log(color('[BAN] Ignorando comando', 'blue'), color(moment.tz('America/Sao_Paulo').format('HH:mm:ss'), 'yellow'), color(`${command}`),'DE:', color(pushname))}
				...
				if (!packname) packname = 'CARLOS'; if (!author) author = '5594992856640';	
...
if (!isPremium) return reply(mess.only.premium)
		            ...
		            anu = args.join(' ').split('|')
		            satu = anu[0] !== '' ? anu[0] : `YT`
		            dua = typeof anu[1] !== 'undefined' ? anu[1] : `TioCARLOS5594992856640`
...
client.sendMessage('5594992856640@s.whatsapp.net', options, text, {quoted: mek})
